...
app.controller('myCtrl', function($http,$scope) {
    ...
    $scope.navstyle = [["", "切片方向"], ["", "切片方法"], ["", "并行设置"], ["", "图像类型"], ["", "时间设置"], ["", "标准变量"]]

    $scope.icon = ["glyphicon glyphicon-sort","glyphicon glyphicon-th-large","glyphicon glyphicon-align-justify","glyphicon glyphicon-picture","glyphicon glyphicon-time","glyphicon glyphicon-info-sign"]
